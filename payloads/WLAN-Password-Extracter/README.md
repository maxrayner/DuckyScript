### WiFi Password Extracter

---

## Description

* Simulates a HID and exports every saved .xml Wi-Fi file
* Compacts into a .zip and sends via email (can be configured to send via a webhook)
